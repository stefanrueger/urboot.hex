...
|368|384|u8.0|`we--jPr-c`|[urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led+b0_pr_ee_ce.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/mcus/atmega324a/watchdog_2_s/internal_oscillator_d-6.25%25/%2B0m128000_hz/%2B%2B%2B1k2_baud/uart1_rxd2_txd3/led%2Bb0/urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led%2Bb0_pr_ee_ce.hex)|
...
### Make commands
```
make MCU=atmega324a WDTO=2S F_CPU=120000L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led+b0
make MCU=atmega324a WDTO=2S F_CPU=120000L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led+b0_pr
make MCU=atmega324a WDTO=2S F_CPU=120000L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led+b0_pr_ee_ce
make MCU=atmega324a WDTO=2S F_CPU=120000L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led+b0_pr_ce
make MCU=atmega324a WDTO=2S F_CPU=120000L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led+b0_pr_ee
make MCU=atmega324a WDTO=2S F_CPU=120000L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=0 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324a_2s_d0m128_1k2_swio_rxd2_txd3_led+b0_ee_ce_hw
```
