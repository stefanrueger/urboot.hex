...
|:-:|:-:|:-:|:-:|:--|
|250|256|u7.7|`w-u-jPr--`|[urboot_m644p_2s_a1m0_2k4_uart0_rxd0_txd1_led+b7.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/mcus/atmega644p/watchdog_2_s/internal_oscillator_a-10.00%25/%2B1m000000_hz/%2B%2B%2B2k4_baud/uart0_rxd0_txd1/led%2Bb7/urboot_m644p_2s_a1m0_2k4_uart0_rxd0_txd1_led%2Bb7.hex)|
...
### Make commands
```
make MCU=atmega644p WDTO=2S F_CPU=7200000L BAUD_RATE=19200 UARTNUM=0 RX=AtmelPD0 TX=AtmelPD1 VBL=1 EEPROM=0 CHIP_ERASE=0 URPROTOCOL=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,4,3,2 NAME=urboot_m644p_2s_a8m0_19k2_uart0_rxd0_txd1_led+b7
make MCU=atmega644p WDTO=2S F_CPU=7200000L BAUD_RATE=19200 UARTNUM=0 RX=AtmelPD0 TX=AtmelPD1 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=0 URPROTOCOL=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,4,3,2 NAME=urboot_m644p_2s_a8m0_19k2_uart0_rxd0_txd1_led+b7_pr
make MCU=atmega644p WDTO=2S F_CPU=7200000L BAUD_RATE=19200 UARTNUM=0 RX=AtmelPD0 TX=AtmelPD1 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=1 URPROTOCOL=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,4,3,2 NAME=urboot_m644p_2s_a8m0_19k2_uart0_rxd0_txd1_led+b7_pr_ce
make MCU=atmega644p WDTO=2S F_CPU=7200000L BAUD_RATE=19200 UARTNUM=0 RX=AtmelPD0 TX=AtmelPD1 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=0 URPROTOCOL=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,4,3,2 NAME=urboot_m644p_2s_a8m0_19k2_uart0_rxd0_txd1_led+b7_pr_ee
make MCU=atmega644p WDTO=2S F_CPU=7200000L BAUD_RATE=19200 UARTNUM=0 RX=AtmelPD0 TX=AtmelPD1 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=1 URPROTOCOL=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,4,3,2 NAME=urboot_m644p_2s_a8m0_19k2_uart0_rxd0_txd1_led+b7_pr_ee_ce
make MCU=atmega644p WDTO=2S F_CPU=7200000L BAUD_RATE=19200 UARTNUM=0 RX=AtmelPD0 TX=AtmelPD1 VBL=0 EEPROM=1 CHIP_ERASE=1 URPROTOCOL=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,4,3,2 NAME=urboot_m644p_2s_a8m0_19k2_uart0_rxd0_txd1_led+b7_ee_ce_hw
make MCU=atmega644p WDTO=2S F_CPU=7200000L BAUD_RATE=19200 UARTNUM=0 RX=AtmelPD0 TX=AtmelPD1 VBL=0 EEPROM=1 CHIP_ERASE=1 URPROTOCOL=0 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,4,3,2 NAME=urboot_m644p_2s_a8m0_19k2_uart0_rxd0_txd1_led+b7_ee_ce_hw_stk500
```
