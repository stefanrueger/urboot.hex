...
### Make commands
```
make MCU=atmega324pb WDTO=1S F_CPU=7900000L BAUD_RATE=19200 SWIO=1 RX=AtmelPE2 TX=AtmelPE3 VBL=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_h8m0_19k2_swio_rxe2_txe3_led+b0
make MCU=atmega324pb WDTO=1S F_CPU=7900000L BAUD_RATE=19200 SWIO=1 RX=AtmelPE2 TX=AtmelPE3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_h8m0_19k2_swio_rxe2_txe3_led+b0_pr
make MCU=atmega324pb WDTO=1S F_CPU=7900000L BAUD_RATE=19200 SWIO=1 RX=AtmelPE2 TX=AtmelPE3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_h8m0_19k2_swio_rxe2_txe3_led+b0_pr_ee_ce
make MCU=atmega324pb WDTO=1S F_CPU=7900000L BAUD_RATE=19200 SWIO=1 RX=AtmelPE2 TX=AtmelPE3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_h8m0_19k2_swio_rxe2_txe3_led+b0_pr_ce
make MCU=atmega324pb WDTO=1S F_CPU=7900000L BAUD_RATE=19200 SWIO=1 RX=AtmelPE2 TX=AtmelPE3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_h8m0_19k2_swio_rxe2_txe3_led+b0_pr_ee
make MCU=atmega324pb WDTO=1S F_CPU=7900000L BAUD_RATE=19200 SWIO=1 RX=AtmelPE2 TX=AtmelPE3 VBL=0 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_h8m0_19k2_swio_rxe2_txe3_led+b0_ee_ce_hw
```
