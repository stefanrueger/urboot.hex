...
### Make commands
```
make MCU=atmega324pb WDTO=1S F_CPU=132800L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_l0m128_1k2_swio_rxd2_txd3_led+b7
make MCU=atmega324pb WDTO=1S F_CPU=132800L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_l0m128_1k2_swio_rxd2_txd3_led+b7_pr
make MCU=atmega324pb WDTO=1S F_CPU=132800L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_l0m128_1k2_swio_rxd2_txd3_led+b7_pr_ee_ce
make MCU=atmega324pb WDTO=1S F_CPU=132800L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_l0m128_1k2_swio_rxd2_txd3_led+b7_pr_ce
make MCU=atmega324pb WDTO=1S F_CPU=132800L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=0 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_l0m128_1k2_swio_rxd2_txd3_led+b7_pr_ee
make MCU=atmega324pb WDTO=1S F_CPU=132800L BAUD_RATE=1200 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=0 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB7 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m324pb_1s_l0m128_1k2_swio_rxd2_txd3_led+b7_ee_ce_hw
```
