...
|378|512|u8.0|`weU-jPr--`|[urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0_pr_ee.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/boards/sanguino/atmega644p/watchdog_2_s/internal_oscillator_m%2B5.00%25/%2B8m000000_hz/%2B%2B28k8_baud/uart1_rxd2_txd3/led%2Bb0/urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led%2Bb0_pr_ee.hex)|
|420|512|u8.0|`weU-jPr-c`|[urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0_pr_ee_ce.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/boards/sanguino/atmega644p/watchdog_2_s/internal_oscillator_m%2B5.00%25/%2B8m000000_hz/%2B%2B28k8_baud/uart1_rxd2_txd3/led%2Bb0/urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led%2Bb0_pr_ee_ce.hex)|
...
### Make commands
```
make MCU=atmega644p WDTO=2S F_CPU=8400000L BAUD_RATE=28800 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0
make MCU=atmega644p WDTO=2S F_CPU=8400000L BAUD_RATE=28800 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0_pr
make MCU=atmega644p WDTO=2S F_CPU=8400000L BAUD_RATE=28800 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0_pr_ce
make MCU=atmega644p WDTO=2S F_CPU=8400000L BAUD_RATE=28800 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0_pr_ee
make MCU=atmega644p WDTO=2S F_CPU=8400000L BAUD_RATE=28800 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0_pr_ee_ce
make MCU=atmega644p WDTO=2S F_CPU=8400000L BAUD_RATE=28800 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=0 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_m8m0_28k8_swio_rxd2_txd3_led+b0_ee_ce_hw
```
