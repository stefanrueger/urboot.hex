...
|:-:|:-:|:-:|:-:|:--|
|254|256|u8.0|`w---jpr--`|[urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/boards/sanguino/atmega644p/watchdog_2_s/internal_oscillator_n%2B6.25%25/%2B0m128000_hz/%2B%2B%2B0k3_baud/uart1_rxd2_txd3/led%2Bb0/urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led%2Bb0.hex)|
...
|418|512|u8.0|`weU-jPr-c`|[urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0_pr_ee_ce.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/boards/sanguino/atmega644p/watchdog_2_s/internal_oscillator_n%2B6.25%25/%2B0m128000_hz/%2B%2B%2B0k3_baud/uart1_rxd2_txd3/led%2Bb0/urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led%2Bb0_pr_ee_ce.hex)|
...
### Make commands
```
make MCU=atmega644p WDTO=2S F_CPU=136000L BAUD_RATE=300 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0
make MCU=atmega644p WDTO=2S F_CPU=136000L BAUD_RATE=300 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0_pr
make MCU=atmega644p WDTO=2S F_CPU=136000L BAUD_RATE=300 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=0 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0_pr_ce
make MCU=atmega644p WDTO=2S F_CPU=136000L BAUD_RATE=300 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=0 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0_pr_ee
make MCU=atmega644p WDTO=2S F_CPU=136000L BAUD_RATE=300 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=1 PROTECTRESET=1 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0_pr_ee_ce
make MCU=atmega644p WDTO=2S F_CPU=136000L BAUD_RATE=300 SWIO=1 RX=AtmelPD2 TX=AtmelPD3 VBL=0 EEPROM=1 CHIP_ERASE=1 LED=AtmelPB0 BLINK=1 AUTOFRILLS=0,6,8..10,5,4,3,2 NAME=urboot_m644p_2s_n0m128_0k3_swio_rxd2_txd3_led+b0_ee_ce_hw
```
