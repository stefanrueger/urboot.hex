...
|:-:|:-:|:-:|:-:|:--|
|254|256|u7.7|`w-u-jPr--`|[urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/u7.7/boards/uno/atmega328pb/watchdog_1_s/external_oscillator_x/%2B2m000000_hz/%2B%2B14k4_baud/uart1_rxb4_txb3/no-led/urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led.hex)|
|254|256|u7.7|`w-u-jPr--`|[urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/u7.7/boards/uno/atmega328pb/watchdog_1_s/external_oscillator_x/%2B2m000000_hz/%2B%2B14k4_baud/uart1_rxb4_txb3/no-led/urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr.hex)|
|284|384|u7.7|`w-u-jPr-c`|[urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr_ce.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/u7.7/boards/uno/atmega328pb/watchdog_1_s/external_oscillator_x/%2B2m000000_hz/%2B%2B14k4_baud/uart1_rxb4_txb3/no-led/urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr_ce.hex)|
|320|384|u7.7|`weu-jPr--`|[urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr_ee.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/u7.7/boards/uno/atmega328pb/watchdog_1_s/external_oscillator_x/%2B2m000000_hz/%2B%2B14k4_baud/uart1_rxb4_txb3/no-led/urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr_ee.hex)|
|346|384|u7.7|`weu-jPr-c`|[urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr_ee_ce.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/u7.7/boards/uno/atmega328pb/watchdog_1_s/external_oscillator_x/%2B2m000000_hz/%2B%2B14k4_baud/uart1_rxb4_txb3/no-led/urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_pr_ee_ce.hex)|
|328|512|u7.7|`weu-hpr-c`|[urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_ee_ce_hw.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/u7.7/boards/uno/atmega328pb/watchdog_1_s/external_oscillator_x/%2B2m000000_hz/%2B%2B14k4_baud/uart1_rxb4_txb3/no-led/urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_ee_ce_hw.hex)|
|432|512|u7.7|`wes-hpr-c`|[urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_ee_ce_hw_stk500.hex](https://raw.githubusercontent.com/stefanrueger/urboot.hex/main/u7.7/boards/uno/atmega328pb/watchdog_1_s/external_oscillator_x/%2B2m000000_hz/%2B%2B14k4_baud/uart1_rxb4_txb3/no-led/urboot_m328pb_1s_x2m0_14k4_uart1_rxb4_txb3_no-led_ee_ce_hw_stk500.hex)|
...
### Avr-gcc commands
```
./avr-toolchain/5.4.0/bin/avr-gcc -DSTART=0x7f00UL -DRJMPWP=0xcfdb -Wl,--section-start=.text=0x7f00 -Wl,--section-start=.version=0x7ffa -DFRILLS=6 -D_urboot_AVAILABLE=16 -g -Wundef -Wall -Os -fno-split-wide-types -mrelax -mmcu=atmega328pb -DF_CPU=16000000L -Wno-clobbered -DWDTO=1S -DBAUD_RATE=115200 -DBLINK=0 -DDUAL=0 -DEEPROM=0 -DURPROTOCOL=1 -DVBL=1 -DCHIP_ERASE=0 -DUARTNUM=1 -DTX=AtmelPB3 -DRX=AtmelPB4 -Wl,--relax -nostartfiles -nostdlib -o urboot_m328pb_1s_x16m0_115k2_uart1_rxb4_txb3_no-led.elf urboot.c
./avr-toolchain/5.4.0/bin/avr-gcc -DSTART=0x7f00UL -DRJMPWP=0xcfdb -Wl,--section-start=.text=0x7f00 -Wl,--section-start=.version=0x7ffa -DFRILLS=6 -D_urboot_AVAILABLE=2 -g -Wundef -Wall -Os -fno-split-wide-types -mrelax -mmcu=atmega328pb -DF_CPU=16000000L -Wno-clobbered -DWDTO=1S -DBAUD_RATE=115200 -DBLINK=0 -DDUAL=0 -DEEPROM=0 -DURPROTOCOL=1 -DVBL=1 -DCHIP_ERASE=0 -DUARTNUM=1 -DTX=AtmelPB3 -DRX=AtmelPB4 -DPROTECTRESET=1 -Wl,--relax -nostartfiles -nostdlib -o urboot_m328pb_1s_x16m0_115k2_uart1_rxb4_txb3_no-led_pr.elf urboot.c
./avr-toolchain/5.4.0/bin/avr-gcc -DSTART=0x7e80UL -DRJMPWP=0xcfa8 -Wl,--section-start=.text=0x7e80 -Wl,--section-start=.version=0x7ffa -DFRILLS=6 -D_urboot_AVAILABLE=100 -g -Wundef -Wall -Os -fno-split-wide-types -mrelax -mmcu=atmega328pb -DF_CPU=16000000L -Wno-clobbered -DWDTO=1S -DBAUD_RATE=115200 -DBLINK=0 -DDUAL=0 -DEEPROM=0 -DURPROTOCOL=1 -DVBL=1 -DCHIP_ERASE=1 -DUARTNUM=1 -DTX=AtmelPB3 -DRX=AtmelPB4 -DPROTECTRESET=1 -Wl,--relax -nostartfiles -nostdlib -o urboot_m328pb_1s_x16m0_115k2_uart1_rxb4_txb3_no-led_pr_ce.elf urboot.c
