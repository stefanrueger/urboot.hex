...
This repository contains 45,407 *different* pre-compiled bootloaders in the directory trees
...
The trees actually contain 134,475 hex files, but they are somewhat
