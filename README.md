# urboot.hex
### Autogenerated bootloaders

The easiest way to [generate and burn](https://github.com/stefanrueger/urboot/blob/main/docs/autogenerated.md) an urboot
bootloader is with AVRDUDE v8.1 or later using virtual
[`urboot:<features>`](https://github.com/stefanrueger/urboot/blob/main/docs/autogenerated.md#possible-features) filenames for
avrdude. If that is not possible, another option is to download precompiled bootloaders from this repository:
